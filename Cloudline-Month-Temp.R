...
#   geom_line( aes(y = Max/0.04),   color = "blue", size=0.1) +
#   geom_text(aes(y = Max/0.04, label= Max),   hjust = 1.5, vjust = 0.5,  size= 3, color= "blue") +
#   geom_line( aes(y = Min/0.04),   color = "red", size=0.1) +
#   geom_text(aes(y = Min/0.04, label= Min),   hjust = 1.5, vjust = 0.5,  size= 3, color= "red") +
#   geom_line( aes(y = Mean/0.04),   color = "brown", size=0.1) +
#   geom_text(aes(y = Mean/0.04, label= Mean),   hjust = 1.5, vjust = 0.5,  size= 3, color= "brown") +
#   scale_x_discrete(breaks = 1:8, labels = c("Sep","Oct","Nov", "Dec", "Jan", "Feb", "Mar", "Apr"))+
#   scale_y_continuous(name = "Cloudline Elevation", limits = c(0, 2000), breaks = seq(0, 2000, by = 500), sec.axis = sec_axis( trans=~.*0.04, name="Temperature"))
# 
# 
# 
# 
...
#   theme(legend.position = "none") +
#   labs(x = "Month", y = "Elevation of the cloudline", title = " ") +
#   geom_line(aes(y = (Mean/100), color = "brown", size = 0.1) +
#   geom_text(aes(y = ((Mean-15)/0.08)+2, label = Mean), hjust = 1.5, vjust = 0.5, size = 3, color = "brown") +
#   scale_x_discrete(breaks = 1:8, labels = c("Sep", "Oct", "Nov", "Dec", "Jan", "Feb", "Mar", "Apr")) +
#   scale_y_continuous(
#     name = "Cloudline Elevation",
#     limits = c(0, 2000),
